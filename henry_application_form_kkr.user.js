      ...
      <div class="krf-container">
        ...
        <div class="krf-body">
          ...
          <div class="krf-section">
            <div class="krf-section-title">患者情報（自動入力）</div>
            <div class="krf-row">
              <div class="krf-field readonly">
                <label>フリガナ</label>
              ...
              <div class="krf-field readonly" style="flex: 0.3;">
                <label>性別</label>
          ...
          <!-- 紹介元情報（自動入力） -->
          <div class="krf-section">
            <div class="krf-section-title">紹介元情報（自動入力）</div>
            <div class="krf-row">
              <div class="krf-field readonly">
                <label>医師名</label>
                <input type="text" value="${escapeHtml(formData.physician_name)}" readonly>
              </div>
              <div class="krf-field readonly" style="flex: 0.5;">
                <label>作成日</label>
