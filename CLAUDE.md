# Henry EMR 開発ガイドライン (Core Rules v4.43)

<!-- 📝 UPDATED: v4.43 - GraphQL API調査メモ記録ルール追加 -->
...
- **IMPORTANT**: GraphQL API調査で手間取ったり、ハマりポイントを発見した場合は、NOTES.mdへの記録を提案すること：
  - 記録する内容: クエリ/mutation名、注意点、ハマったポイント
  - 全APIを網羅的に記録する必要はない。「次回の自分が助かる情報」だけ残す
  - 記録場所: `NOTES.md` の「GraphQL API 調査メモ」セクション
